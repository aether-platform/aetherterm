...
class WorkspaceTab:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'WorkspaceTab':
        return cls(
            ...
            last_activity=datetime.fromisoformat(data['lastActivity']) if 'lastActivity' in data else datetime.utcnow()
        )
...
class Workspace:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'layout': {
                ...
                'configuration': self.layout_config
            },
            'createdAt': self.created_at.isoformat(),
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Workspace':
        ...
        return cls(
            ...
            created_at=datetime.fromisoformat(data['createdAt']) if 'createdAt' in data else datetime.utcnow(),
            last_accessed=datetime.fromisoformat(data['lastAccessed']) if 'lastAccessed' in data else datetime.utcnow(),
