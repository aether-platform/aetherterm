...
from aetherterm.agentserver.presentation.routes.routes import router
from aetherterm.agentserver.presentation.web.config import (
    DEFAULT_CONFIG,
    parse_environment_config,
)
from aetherterm.agentserver.presentation.web.config.app_factory import (
    LegacyApplicationFactory,
)
from aetherterm.agentserver.presentation.websocket import socket_handlers
...
async def start_server(**kwargs):
    ...
    # Socket.IO event handlers are registered in setup_app() function
    ...
    # AI チャットとログ検索
    from aetherterm.agentserver.presentation.handlers import ai_handlers
    ...
    try:
        from aetherterm.agentserver.presentation.handlers import supervisord_handlers
...
def setup_app(**kwargs):
    ...
    sio.on("ai_reset_retry", ai_handlers.ai_reset_retry)
    ...
    async def startup_inventory_service():
        try:
            from aetherterm.agentserver.domain.services.inventory_service import inventory_service
