...
class SocketIOEventRegistrar:
    ...
    def register_all_handlers(self) -> None:
        ...
        self._register_workspace_handlers()
    ...
    def _register_workspace_handlers(self) -> None:
        """Register minimal global workspace handlers."""
        handlers = [
            ("workspace_connect", socket_handlers.on_workspace_connect),
            ("tab_create", socket_handlers.on_tab_create),
        ]
    ...
    def _setup_lifecycle_events(self, asgi_app: Any) -> None:
        ...
        if hasattr(asgi_app, "other_asgi_app") and asgi_app.other_asgi_app:
            ...
            fastapi_app.add_event_handler(
                "startup", self.lifecycle_manager.execute_startup_sequence
            )
            fastapi_app.add_event_handler(
